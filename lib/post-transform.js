...
export default function transform(src) {
  ...
  function getDocumentedParams(params, comment) {
    ...
    while (j < knownParams.length) {
      ...
      if (!param) {
        throw new Error(`documented parameter <${ expectedName }> at index <${j}> not found`);
      }
      ...
      if (actualName !== expectedName) {
        throw new Error(`documented parameter <${ expectedName }> at index <${j}> differs from actual parameter <${ actualName }>`);
      }
